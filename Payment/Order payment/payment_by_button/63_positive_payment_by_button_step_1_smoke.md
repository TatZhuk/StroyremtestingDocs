* Тестовые данные:
 ...
 Открыть  "Оплатить заказ" с главной страницы, после его оформления неавторизованным пользователем.
...
| 3   | 2023-04-09 | 10:12 |Chrome 116.0.5845.97 Yandex 23.7.2.765| PASS | Chrome 116.0.5845.97               | PASS | 03.09 | Сабина  |
